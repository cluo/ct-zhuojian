...
//				tag *= -1;
     ...
     * @param ma
     * @param mb
     * @param operatorB �ڵ�mb�����ϵĲ���
     * @param operatorA ��ma����Ԫ���ϵĲ���
     * @return
     */
    ...
    private static void testScaleMatrix() {
        ...
        for (int i = 0; i < m.length; i++)
            for (int j = 0; j < m[0].length; j++)
                m[i][j] = count++;
        double[][] out = scaleMatrix(m, new Layer.Size(2, 2));
        Util.printMatrix(m);
        Util.printMatrix(out);
    }
    ...
    private static void testKronecker() {
        ...
        for (int i = 0; i < m.length; i++)
            for (int j = 0; j < m[0].length; j++)
                m[i][j] = count++;
        double[][] out = kronecker(m, new Layer.Size(2, 2));
        Util.printMatrix(m);
        System.out.println();
        Util.printMatrix(out);
    }
